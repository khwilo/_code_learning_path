...
print "We can also do that this way:";print "We'd have %d beans, %d jars, and %d crabapples." % secret_formula(start_point)

sentence = "All good\tthings come to those who weight."

words = ex25.break_words(sentence);sorted_words = ex25.sort_words(words)

print_first_word(words);print_last_word(words);print_first_word(sorted_words);print_last_word(sorted_words);sorted_words = ex25.sort_sentence(sentence)
print sorted_words
